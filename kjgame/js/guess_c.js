...
//小框
// 第一排：數字鍵 1 2 3 4 ... 8 9 0 - =
make_button("rgb(255, 133, 133)", ["幫", "滂", "並", "明"], "kb1", 0, 0);       // 1~4
make_button("rgb(118, 123, 255)", ["精", "清", "從", "心", "邪"], "kb4", 400, 0); // 8~=

// 第二排：Q W E R ... U I O P [
make_button("rgb(173, 255, 126)", ["端", "透", "定", "泥"], "kb2", 50, 60);      // Q~R
make_button("rgb(132, 175, 255)", ["莊", "初", "崇", "生", "俟"], "kb5", 450, 60); // U~[

// 第三排：A S D F ... H J K L ;
make_button("rgb(122, 255, 153)", ["知", "徹", "澄", "娘"], "kb3", 75, 120);     // A~F
make_button("rgb(126, 221, 255)", ["章", "昌", "常", "書", "船"], "kb6", 475, 120); // H~;

// 第四排：Z X C V ... B N M , .
make_button("rgb(253, 255, 120)", ["見", "溪", "群", "疑"], "kb7", 100, 180);     // Z~V
make_button("rgb(255, 209, 130)", ["影", "云", "以", "曉", "匣"], "kb8", 500, 180); // B~.
